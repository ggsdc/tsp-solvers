...
def main():
    ...
    # pso = ParticleSwarmOptimization(g, 100, 10, 0.2, 0.2, 120, plot=True)
    # pso.run()
    # pso.get_best()

    # dynamic_programming = DynamicProgramming(g)
    # dynamic_programming.run()
    # dynamic_programming.get_best()
